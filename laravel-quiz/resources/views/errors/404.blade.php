...
<body>
<h1>404 HATA!</h1>
<p class="zoom-area"><b>Aradığınızı bulamadıysanız tekrar aramayı deneyin
        Ya da aradığınız şey sayfa yöneticileri tarafından silinmiş olabilir</b></p>
...
<div class="link-container">
    <a href="{{route('quizzes.index')}}" class="more-link">GERİ DÖN</a>
</div>
</body>
</html>
